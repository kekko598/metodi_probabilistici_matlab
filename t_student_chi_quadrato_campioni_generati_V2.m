...
scatter(X, zeros(n,1), 'MarkerEdgeColor', 'black', 'MarkerFaceColor', 'yellow');
hold off;

legend({'t-student', 'chi-quadrato', 'Intervallo di confidenza t-student', 'Intervallo di confidenza chi-quadrato', 'Dati casuali'});
xlabel('x');
ylabel('Funzione densità');
title('Funzione densità di t-student e chi-quadrato con i dati casuali');